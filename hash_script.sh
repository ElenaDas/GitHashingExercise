...
if [[ $user_input =~ ^[0-9]{4}$ ]]; then
    ...
    echo "Generated 4-digit decimal hash: $dec_hash"
    echo "Generated 4-digit hexadecimal hash: $hex_hash"

    # Save the output to output.txt
    echo -e "Generated 4-digit decimal hash: $dec_hash\nGenerated 4-digit hexadecimal hash: $hex_hash" > hash_output.txt
